...
export class MachineProductionChartPauseParetoComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  ngAfterViewInit() {  
    this.chartPausa = this.AmCharts.makeChart("amChartParetoPausa", this.makeOptions([]));
    this.chartProduto = this.AmCharts.makeChart("amChartParetoProduto", this.makeOptionsProduct([]));
  }  
